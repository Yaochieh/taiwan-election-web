                ...
                return (
                  <div key={t.target_id} className="py-5 sm:py-6">
                    ...
                    <div className="flex items-baseline gap-x-3 gap-y-1 flex-wrap mb-3">
                      ...
                      <span className="ml-auto font-serif text-2xl sm:text-3xl font-bold tabular-nums shrink-0">
                    ...
                    {/* 開票條 + 目標刻度線 */}
                    <div
                      className="relative h-4 bg-rule/40 mb-2"
                      role="img"
            ...
            <div className="grid sm:grid-cols-2 border-y border-rule divide-y divide-rule sm:divide-y-0">
              {met.map((t) => {
                ...
                return (
                  <div
                    key={t.target_id}
                    className="flex items-baseline gap-x-2 py-3 sm:py-3.5 sm:pr-8 sm:[&:nth-child(odd)]:border-r sm:border-rule sm:[&:nth-child(n+3)]:border-t"
                  >
                    ...
                    {t.progress_source_url ? (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="ml-auto font-serif font-bold tabular-nums text-accent-red shrink-0 hover:underline underline-offset-4"
                        title="資料來源"
                      >
                        {t.metric_unit === "政策開辦"
                          ? "已開辦"
