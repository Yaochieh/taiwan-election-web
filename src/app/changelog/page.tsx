...
const CHANGELOG: Entry[] = [
  {
    ...
    items: [
      ...
      "/elections/[id] 總統頁加入「全國得票 Treemap」+「縣市勝出政黨地圖」+ 點縣市下鑽鄉鎮",
      "/trends 加入「歷屆立委席次（區域+原住民）」第三段",
      "政黨頁加上「歷屆立委席次橫條圖」",
      "/government/cabinet 完成：總統府/行政院/五院/14 部會首長現況",
      "/people/search 列建議政治人物分組",
      "/people/compare 多人並列比較（政黨歷程、勝率、主要參選紀錄）",
      "/data/turnout 補入歷屆總統/縣市長/立委投票率",
      "/data/downloads 補入 API endpoints 一覽",
      "2016/2020/2012 正副總統 background 對調修正",
    ],
  },
  {
    date: "2026-05",
